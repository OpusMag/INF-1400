...
class Ball:
    def __init__(self):
        ...
        self.ball_radius = 5
        self.ball_speed = Vector2(30, 30)
    
    def draw_ball(self, screen):
        #pygame.draw.crcle((screen), (192, 192, 192), (self.ball_pos_x, self.ball_pos_y), self.ball_radius)
        pygame.draw.circle(screen, (192, 192, 192), (int(self.ball_pos.x), int(self.ball_pos.y)), self.ball_radius, 0)
