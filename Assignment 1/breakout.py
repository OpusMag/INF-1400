...
def breakout():
    ...
    class Paddle():
        def __init__(self):
            ...
            self.paddle_pos_x = pygame.mouse.get_pos()
    ...
    class Ball():
        def __init__(self):
            self.ball_radius = 5
            self.ball_pos = Vector2(x, y)

        def move(self):
            self.ball_speed = Vector2(2, -2)
    
        def draw(self):
            circle = pygame.circle(self, ball_radius, ball_pos_x, ball_pos_y, ball_speed_x, ball_speed_y)
            pygame.draw.rect(screen, (192, 192, 192), (ball_radius, ball_pos_x, ball_pos_y, ball_speed_x, ball_speed_y))
        ...
        impulse = intersect_brick_red_ball(brick_red_position_x,
                                            brick_red_position_y,
                                            brick_red_size_x,
                                            brick_red_size_y,
                                            ball_position,
        ...
        impulse = intersect_brick_green_ball(brick_green_position_x,
                                            brick_green_position_y,
                                            brick_green_size_x,
                                            brick_green_size_y,
                                            ball_position,
        ...
        impulse = intersect_brick_blue_ball(brick_blue_position_x,
                                            brick_blue_position_y,
                                            brick_blue_size_x,
                                            brick_blue_size_y,
                                            ball_position,
