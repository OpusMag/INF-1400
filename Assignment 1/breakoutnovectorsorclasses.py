...
#class and methods for the paddle
    ...
    def draw_paddle(self, screen):
        ...
        pygame.draw.circle(screen, (155, 155, 155), (self.paddle_rect.x, self.paddle_rect.y), self.paddle_radius)
...
#class and methods for the ball
    ...
    def draw_ball(self, screen):
        ...
        pygame.draw.circle(screen, (255, 255, 255), (self.ball_rect.x, self.ball_rect.y), self.ball_radius)
    ...
    def move_ball(self):
        ...
        if pygame.Rect.colliderect(self.ball_rect, self.paddle_rect):
            if abs(self.ball_rect.bottom - self.paddle_rect.top) < collision_tolerance and self.ball_speed_y > 0:
                self.ball_speed_y *= -1
            #if abs(self.ball_rect.top - self.paddle_rect.bottom) < collision_tolerance and self.ball_speed_y < 0:
                #self.ball_speed_y *= -1
            if abs(self.ball_rect.left - self.paddle_rect.right) < collision_tolerance and self.ball_speed_x > 0:
                self.ball_speed_x *= -1
            if abs(self.ball_rect.right - self.paddle_rect.left) < collision_tolerance and self.ball_speed_x < 0:
                self.ball_speed_x *= -1
        ...
        for row in self.brick:
            brick_count = 0
            for brick in row:
                if pygame.Rect.colliderect(self.ball_rect, brick[0]):
                    if abs(self.ball_rect.bottom - brick[0].top) < collision_tolerance and self.ball_speed_y > 0:
                        self.ball_speed_y *= -1
                    if abs(self.ball_rect.top - brick[0].bottom) < collision_tolerance and self.ball_speed_y < 0:
                        self.ball_speed_y *= -1
                    if abs(self.ball_rect.left - brick[0].right) < collision_tolerance and self.ball_speed_x > 0:
                        self.ball_speed_x *= -1
                    if abs(self.ball_rect.right - brick[0].left) < collision_tolerance and self.ball_speed_x < 0:
                        self.ball_speed_x *= -1
